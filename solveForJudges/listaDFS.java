...
public class listaDFS {
	public static BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
	public static BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(System.out));
	public static AdjListGraph<Integer> a = new AdjListGraph<Integer>(true,true);
	...
	public static void exe() throws NumberFormatException, IOException {
...
static class AdjListGraph<T> {
 ...
 static class AdjVertex<T> extends Vertex<T> {
